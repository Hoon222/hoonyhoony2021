...
myToken = "xoxb-2436109877958-2440029299653-XWEu0zbRTsoll8axHmkcIHul"
...
def get_target_price(ticker, k):
    """변동성 돌파 전략으로 매수 목표가 조회""" # 3일동안 가격 조회
...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and ma10 < predicted_close_price:
                krw = get_balance("KRW")
                if krw > 5000:
